...
const Colleges = () => {
    ...
    return (
        <Container>
            ...
            <div>
                <DetailsCard name={'Explore Our College'} intro={'Discover a diverse range of institutions and their unique offerings.'} img={'https://i.ibb.co/yN5zd7S/Untitled-design-3.png'}></DetailsCard>
            </div>
